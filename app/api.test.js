...
describe("API Products Test Suite", () => {
    ...
    before(async () => {
       ...
       new Promise(resolve => _server.once('listening', resolve))
    })
    before(async () => setToken())
    it('should create premium product', async () => {
        const input = {
    ...
    it('should create regular product', async () => {
        const input = {
    ...
    it('should create basic product', async () => {
        const input = {
            description : 'fio',
            price : 2
        }
